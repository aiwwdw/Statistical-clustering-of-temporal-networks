...
# 다섯 개의 CSV 파일을 읽어옵니다.
file_paths = [
    'output/result_low_minus_100_5_0p75.csv',
    'output/result_low_plus_100_5_0p75.csv',
    'output/result_medium_minus_100_5_0p75.csv',
    'output/result_medium_plus_100_5_0p75.csv',
    'output/result_medium_with_affiliation_100_5_0p75.csv'
]
...
for file_path, label in zip(file_paths, labels):
    ...
    melted_data = data.melt(value_vars=['global_ari', 'average_ari'], 
                            var_name='ARI_Type', 
...
# Boxplot 생성 (범례 없이)
sns.boxplot(x='label', y='ARI_Value', data=combined_data[combined_data['ARI_Type'] == 'global_ari'],
            color='white', width=0.32, linewidth=1.5, 
            positions=positions_global, meanline=True, showmeans=True, meanprops=meanprops)

sns.boxplot(x='label', y='ARI_Value', data=combined_data[combined_data['ARI_Type'] == 'average_ari'],
...
# 플롯을 파일로 저장합니다.
output_file_path = 'boxplot_combined_global_average_spaced.png'
