...
def eval(bernoulli_case, num_nodes, time_stamp, stability, total_iteration, trial = 0):
    """""
    compute ARI, J value,
    """""
...
if __name__ == "__main__":
    ...
    eval(bernoulli_case =bernoulli_case, num_nodes = num_nodes, time_stamp = time_stamp , stability = stability, total_iteration = iteration, trial = trial)
