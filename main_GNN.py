...
def inital_gradient(intitalization, device):
...
def main(time_stamp = 10, num_latent = 2, num_nodes = 100, stability = 0.9, total_iteration = 0, distribution = 'Bernoulli', bernoulli_case = 'medium_plus', num_trials = 1, mode = 'new'):
    ...
    GNN_trial_global_ARI = []
    GNN_trial_average_ARI = []
    GNN_trial_loss = []
    ...
    for j in range(num_trials):
        ...
        GNN_loss = GNN_estimate(adjacency_matrix = Y, 
                        initialization = intitalization_new_pre,
                        num_latent = num_latent, 
                        stability = stability, 
                        total_iteration = total_iteration, 
        ...
        GNN_trial_global_ARI.append(GNN_global_ARI)
        GNN_trial_average_ARI.append(GNN_average_ARI)
        GNN_trial_loss.append(GNN_loss.item())
